...
Route::group(['prefix' => 'learn', 'as' => 'learn.',  'middleware' => ['auth']], function () {
    Route::get('/courses', [\App\Http\Controllers\StudentController::class, 'courses'])->name('courses.index');
    Route::get('/courses/{course}', [\App\Http\Controllers\StudentController::class, 'course'])->name('courses.show');

    Route::get('/tests', [\App\Http\Controllers\StudentController::class, 'tests'])->name('tests.index');
    Route::get('/tests/{test}', [\App\Http\Controllers\StudentController::class, 'test'])->name('test.show');
    Route::post('/tests', [\App\Http\Controllers\StudentController::class, 'testStore'])->name('test.store');
...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    Route::post('notifications/media', 'NotificationsController@storeMedia')->name('notifications.storeMedia');
    Route::post('notifications/ckmedia', 'NotificationsController@storeCKEditorImages')->name('notifications.storeCKEditorImages');
