        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.lessons.update", [$lesson->id]) }}"
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control {{ $errors->has('short_text') ? 'is-invalid' : '' }}"
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control {{ $errors->has('long_text') ? 'is-invalid' : '' }}" name="long_text"
                              id="long_text">{{ old('long_text', $lesson->long_text) }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('position') ? 'is-invalid' : '' }}" type="number"
                           name="position" id="position" value="{{ old('position', $lesson->position) }}" step="1">
                ...
                <div class="form-group">
                    <div class="form-check {{ $errors->has('is_free') ? 'is-invalid' : '' }}">
                        ...
                        <input class="form-check-input" type="checkbox" name="is_free" id="is_free"
                               value="1" {{ $lesson->is_free || old('is_free', 0) === 1 ? 'checked' : '' }}>
