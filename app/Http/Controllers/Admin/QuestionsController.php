...
class QuestionsController extends Controller
{
    ...
    public function index()
    {
        ...
        if(auth()->user()->isProfessor) {
            $testIds = auth()->user()->testsAsProfessor->pluck('id');
            $questions = $questions->whereIn('test_id', $testIds);
        }
    ...
    public function create()
    {
        ...
        if(auth()->user()->isProfessor) {
            $courseIds = auth()->user()->coursesAsProfessor->pluck('id');
            $tests = Test::whereIn('course_id', $courseIds)->pluck('title', 'id')->prepend(trans('global.pleaseSelect'), '');
        }
